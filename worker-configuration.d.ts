/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3d15874f9c7e841de92cc64b2c209ae2)
// Runtime types generated with workerd@1.20260820.1 2025-10-08 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	R2: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	LOGIN_CODE_RATE_LIMITER: RateLimit;
	VERIFY_RATE_LIMITER: RateLimit;
	CREATE_RATE_LIMITER: RateLimit;
	SEND_RATE_LIMITER: RateLimit;
	INBOX_DOMAIN: "headlesstools.fayazahmed.com";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INBOX_DOMAIN">> {}
}
